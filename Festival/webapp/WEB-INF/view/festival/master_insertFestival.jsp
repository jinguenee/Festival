...
// 						|| "" == detail_notice || "" == location_x || "" == location_y || "" == thema1 || "" == thema2 || "" == thema3
...
// 			}); // end of click
			...
			$("#btn_insertFestival").click(function(){
				...
				$.ajax({
					type : "post",
					url : "/Festival/festival/master_insertFestival_Proc.do",
					processData : false,
					contentType : false,
					data : formData,
					success : function(data) {
						if (data.result == "ok") {
							...
							location.replace("/Festival/festival/master_selectFestival.do?festival_no=" + data.fBean.festival_no);
						} else {
							alert(data.resultMsg);
						}
					}
