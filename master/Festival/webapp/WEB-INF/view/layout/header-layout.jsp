...
<!-- 					<li><a href="/member/loginForm.do?bdCategoryCd=01">LOGIN</a></li> -->
 						...
 						<li><a href="mylist.html">마이페이지</a></li>
					</c:if>
					
                	<!-- 로그인이 되어 있을 때 화면 -->
					<c:if test="${!empty memberBean}">
						<li><a href="/member/info.do?bdCategoryCd=01">마이페이지</a></li>
            ...
            <div class="menu_box2">
                <ul class="menu_title">
                    <li>
                     ...
                     <li>
                        <a href="/board/noticeList.do">커뮤니티</a>
                        <ul class="menu_list">
                            <li><a href="/board/noticeList.do">자유게시판</a></li>
